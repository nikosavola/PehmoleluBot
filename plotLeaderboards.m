...
[bestAmounts, sortIndex] = sort(amount, 'descend');
I = sortIndex(1:10);
%[bestAmounts, I] = maxk(amount,10); % or maxk
...
h = barh( flip(bestAmounts(1:10)),'BarWidth',0.5,'FaceColor',[86.3, 0, 42.4]./100,'LineWidth',0.7);
